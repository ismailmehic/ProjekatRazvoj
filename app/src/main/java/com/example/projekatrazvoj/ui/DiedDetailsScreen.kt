...
@Composable
fun DiedDetailsScreen(died: Died?, onShare: () -> Unit) {
    if (died == null) {
                ...
                Row(modifier = Modifier.fillMaxSize().padding(16.dp), horizontalArrangement = Arrangement.spacedBy(24.dp)) {
                    Card(
                        ...
                        Column(
                            ...
                            Text(
                                text = died.municipality ?: "Nepoznato",
                    ...
                    Column(modifier = Modifier.weight(1f).fillMaxHeight(), verticalArrangement = Arrangement.SpaceBetween) {
                        Column {
                            Text(
                                text = "Prikaz broja umrlih po polu",
                            ...
                            val barValues = listOf(died.maleTotal ?: 0, died.femaleTotal ?: 0, died.total ?: 0)
